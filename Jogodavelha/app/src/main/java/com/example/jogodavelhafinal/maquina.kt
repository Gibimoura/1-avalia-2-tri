...
import com.example.jogodavelhafinal.databinding.ActivityjogadorBinding
import com.example.jogodavelhafinal.databinding.ActivitypcBinding
import kotlin.random.Random

class pc : AppCompatActivity() {
    private lateinit var binding: ActivitypcBinding
    //Vetor "3D" é o design do jogo
    val design = arrayOf(
        arrayOf("A", "B", "C"),
        arrayOf("D", "E", "F"),
        arrayOf("G", "H", "I")
    ...
    //variável que indica qual pessoa está jogando
    var pessoaAtual = "X"
